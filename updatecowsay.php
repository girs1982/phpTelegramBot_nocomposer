...
if (!empty($callback_query)) {
    ...
    else if($bo=='bomb'){$reply = " Telegram PHP API  https://github.com/girs1982?tab=repositories\nGansta-Girs api mod";}
    else{
...
if ($text == '/start') {
  //  $option = [["\xF0\x9F\x92\xA3"], ['Git', 'Credit']];
    $option = array( array( $telegram->buildInlineKeyboardButton("\xF0\x9F\x92\xA3","","bomb",""),$telegram->buildInlineKeyboardButton($text="Gansta","","como","gansta") ) );
